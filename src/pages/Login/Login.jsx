...
export const Login = () => {
    return (
        <div className=''>
            {/* <hr className='h-2 imm-main-color w-full' /> */}
            <div className='mx-auto flex max-w-7xl items-center  px-6 lg:px-8'  aria-label='Global'>
                        ...
                        <form className="space-y-6" action="#" method="POST">
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <div className="text-sm">
                                    Belum punya akun?
                                    <Link to='/register' className="font-semibold px-1 text-black hover:text-indigo-500">
                                        Daftar
                                    </Link>
                                </div>
                            </div>
                ...
                <div className='hidden lg:block'>
                    <img src="src/assets/images/login-logo.svg" alt="" />
                </div>
            </div>
        </div>
    )
